...
{	
	...
	"UPDATE kamar3 SET nomor_kamar='$nomor_kamar',tipe_kamar='$tipe_kamar',keterangan='$keterangan',harga='$harga' 
...
$result = mysqli_query($koneksi, "SELECT * FROM kamar3 WHERE nomor_kamar=$id");
...
<body>
	...
	<form name="update_user" method="post" action="update_kamar3.php">
		<table border="0">
			<tr> 
				<td>NOMOR KAMAR</td>
